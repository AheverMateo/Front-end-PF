...
// Initializar services Google
 ...
 const onSuccess = (response)=>{
    setUserGoogle({
      ...userGoogle, email: response.profileObj.email, password: response.profileObj.googleId, name: response.profileObj.name
    });
 }
  ...
  return (
    <div>
        ...
        <GoogleLogin
            ...
            buttonText={location.pathname === '/Login' ? 'Login with Google' : 'Sign in with Google'}
